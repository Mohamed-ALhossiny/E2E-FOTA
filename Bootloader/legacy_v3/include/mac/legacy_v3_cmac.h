/**
  *******************************************************************************
  * @file    legacy_v3_cmac.h
  * @author  MCD Application Team
  * @brief   Header file of CMAC helper for migration of cryptographics
  *          library V3 to V4
  *******************************************************************************
  * @attention
  *
...
#ifndef LEGACY_V3_CMAC_H
#define LEGACY_V3_CMAC_H
...
typedef struct
{
  cmox_cmac_handle_t cmac_handle;
...
/**
  ...
  * @note \c P_pAESCMACctx.mTagSize must be set with the size of authentication TAG that will be generated by
  *       the \ref AES_CMAC_Encrypt_Finish
  */
...
/**
  ...
  *       The last call allows any positive value for P_inputSize but in the last call to this function
  *       the flag E_SK_FINAL_APPEND \b must \b be \b set inside P_pAESCMACctx->mFlags
  *       (i.e. with a simple P_pAESCMACctx->mFlags |= E_SK_FINAL_APPEND )
  */
...
/**
  ...
  * @note \c P_pAESCMACctx.pmKey (see \ref AESCMACctx_stt) must be set with a pointer to the AES key
  *          before calling this function.
  * @note \c P_pAESCMACctx.mKeySize (see \ref AESCMACctx_stt) must be set with the size of the key prior to
  ...
  * @note \c P_pAESCMACctx.mFlags must be set prior to calling this function. Default value is E_SK_DEFAULT.
  *          See \ref SKflags_et for details.
  * @note \c P_pAESCMACctx.pmTag must be set with a pointer to the authentication TAG that will be checked
  *       during \ref AES_CMAC_Decrypt_Finish
  * @note \c P_pAESCMACctx.mTagSize must be set with the size of authentication TAG that will be checked by
  *       the \ref AES_CMAC_Decrypt_Finish
  * @remark This function is just a helper for \ref AES_CMAC_Encrypt_Init
 */
