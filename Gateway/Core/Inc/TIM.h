...
#define TIM1_BASE             (0x40000000UL + 0x00010000UL + 0x0000UL)
#define TIM2_BASE             (0x40000000UL + 0x0000UL)
#define TIM3_BASE             (0x40000000UL + 0x0400UL)
#define TIM4_BASE             (0x40000000UL + 0x0800UL)
#define TIM5_BASE             (0x40000000UL + 0x0C00UL)
#define TIM6_BASE             (0x40000000UL + 0x1000UL)
#define TIM7_BASE             (0x40000000UL + 0x1400UL)
#define TIM8_BASE             (0x40000000UL + 0x00010000UL + 0x0400UL)
#define TIM9_BASE             (0x40000000UL + 0x00010000UL + 0x4000UL)
#define TIM10_BASE            (0x40000000UL + 0x00010000UL + 0x4400UL)
#define TIM11_BASE            (0x40000000UL + 0x00010000UL + 0x4800UL)
#define TIM12_BASE            (0x40000000UL + 0x1800UL)
#define TIM13_BASE            (0x40000000UL + 0x1C00UL)
#define TIM14_BASE            (0x40000000UL + 0x2000UL)
