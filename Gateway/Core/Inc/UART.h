...
//stop bits
#define UART_1STOPBIT		0x0
#define UART_0STOPBIT5		USART_CR2_STOP_0
#define UART_STOPBIT2		USART_CR2_STOP_1
#define UART_1STOPBIT5		USART_CR2_STOP
...
#define USART1_BASE           (0x40000000UL + 0x00010000UL + 0x1000UL)
#define USART2_BASE           (0x40000000UL + 0x4400UL)
#define USART3_BASE           (0x40000000UL + 0x4800UL)
#define UART4_BASE            (0x40000000UL + 0x4C00UL)
#define UART5_BASE            (0x40000000UL + 0x5000UL)
#define USART6_BASE           (0x40000000UL + 0x00010000UL + 0x1400UL)

#define USART1              ((USART_TypeDef *) USART1_BASE)//APB2
#define USART2              ((USART_TypeDef *) USART2_BASE)//APB1
#define USART3              ((USART_TypeDef *) USART3_BASE)//APB1
#define UART4               ((USART_TypeDef *) UART4_BASE)//APB1
#define UART5               ((USART_TypeDef *) UART5_BASE)//APB1
#define USART6              ((USART_TypeDef *) USART6_BASE)//APB2


#define UAST_OVERSAMPLING_8					1
#define UAST_OVERSAMPLING_16				0
/******************************************************************************/
/*                                                                            */
